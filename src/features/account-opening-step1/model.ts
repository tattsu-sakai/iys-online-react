...
export const introDocumentNames = [
  "兼 保護預り口座設定申込書　兼 野村MRF自動けいぞく投資取引申込書　兼 外国証券取引口座設定申込書　兼 野村自動スイープ申込書　兼 総合取引申込書　兼 累積投資取引申込書　兼 振替決済口座開設申込書　兼 いちよしメンバーズクラブ申込書　兼 株式配当金振込指定書　兼 内部者届出書",
  "兼 特定取引を行う者の届出書",
] as const;
...
export const applicationStatement = [
  "いちよし証券御中",
  "私は、以降に入力する内容で、「いちよしの証券総合サービス約款・規程集」・「野村MRFの目論見書」に基づき、総合取引、証券総合サービスの利用、外国証券取引口座の設定を申込みます。",
] as const;

export const electronicDeliveryDocuments = [
  "いちよしの証券総合サービス約款 取扱規定",
  "重要情報シート（事業者編）",
  "契約締結前交付書面集",
  "リスク・手数料等説明ページのご案内",
  "野村MRF目論見書",
...
export const step1Documents: Step1Document[] = [
  {
    key: "terms",
    nodeId: "32374:77307",
    title: "いちよしの証券総合サービス約款 取扱規程",
    description:
      "当社との契約内容に加え、いちよしメンバーズクラブ、書面交付、勧誘方針、個人情報の取扱い、最良執行方針などが記載されています。",
    previewAlt: "いちよしの証券総合サービス約款 取扱規程のプレビュー",
    previewSrc: `${previewBasePath}/terms-preview.png`,
    confirmText:
      "「いちよしの証券総合サービス約款 取扱規程」を確認しました",
  },
  {
    key: "businessInfo",
    nodeId: "32374:75502",
